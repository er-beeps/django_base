...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('request_url', models.CharField(blank=True, max_length=256, null=True, verbose_name='url')),
                ('request_method', models.CharField(blank=True, db_index=True, max_length=10, null=True, verbose_name='http method')),
                ('response_code', models.CharField(blank=True, db_index=True, max_length=3, null=True, verbose_name='response code')),
